...
const MOCK_USDC_ADDRESS = process.env.MOCK_USDC_ADDRESS || '0xB619524d45031e27B7211A2C7847eAEa94913a2a';
const MOCK_VAULT_ADDRESS = process.env.MOCK_VAULT_ADDRESS || '0x82a61C8d06507C528bd40D737a5B41E15fA0CA17';
